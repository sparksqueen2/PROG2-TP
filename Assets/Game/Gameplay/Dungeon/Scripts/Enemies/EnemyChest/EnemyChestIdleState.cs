...
public class EnemyChestIdleState : IEnemyState
{
    ...
    public void EnterState()
    {
        ...
        if (_controller.IsWaveCombat)
        {
            _controller.SetWaveAgentLocked(true);
            _controller.ForceAlertPose();
        }
    }
    ...
    {
        if (_controller.IsWaveCombat)
            _controller.MaintainWaveIdlePose();
        ...
        else if (!_controller.IsNearItemToProtect() && !_controller.IsWaveCombat)
        {
